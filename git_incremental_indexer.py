...
# Add the git subdirectory to Python path for imports
sys.path.insert(0, str(Path(__file__).parent / 'git'))

from git import Repo  # GitPython
from src_vectorizer import SourceVectorizer

class IncrementalIndexer:
    def __init__(self, db_path: str = "./chroma_db", repos_dir: str = "./git/repos"):
...
def main():
    ...
    parser.add_argument("--repos-dir", default="./git/repos", help="Repositories directory")
